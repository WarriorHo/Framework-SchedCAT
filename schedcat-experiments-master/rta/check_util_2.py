...
def test(conf):
    # output_file = 'output/test_util_small_task_set.txt'
    output_file = 'output/test_util_include_generate_2.txt'
    output_dir = os.path.dirname(output_file)
    if output_dir and not os.path.exists(output_dir):
        os.makedirs(output_dir)
    
    with RedirectStdoutToFile(output_file):
